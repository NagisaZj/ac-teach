...
class ReplayBuffer(object):
    ...
    def add(self, env_obs, action, reward, next_env_obs, done, task_obs,info=None,t=0):
    ...
    def sample(self, index=None) -> ReplayBufferSample:
        ...
        return ReplayBufferSample(
            env_obses, actions, rewards, next_env_obses, not_dones, env_indices, idxs,infos,ts
        )
